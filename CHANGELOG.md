...
* (FPTI) add logs for axo (#2289) ([bc94877](https://github.com/paypal/paypal-checkout-components/commit/bc94877)), closes [#2289](https://github.com/paypal/paypal-checkout-components/issues/2289)
...
* [Button Redesign] Shape 👾 (#2323) ([3e84001](https://github.com/paypal/paypal-checkout-components/commit/3e84001)), closes [#2323](https://github.com/paypal/paypal-checkout-components/issues/2323)
* [DTPPCPSDK-2627] [DTPRP-1650] Set up new subscriptions callbacks (#2449) ([e4bb4c2](https://github.com/paypal/paypal-checkout-components/commit/e4bb4c2)), closes [#2449](https://github.com/paypal/paypal-checkout-components/issues/2449)
* [DTPPCPSDK-2824] [DTPRP-1734] [DTPRP-1751] Limit eligible button to Paypal when new createSubscripti ([769aad1](https://github.com/paypal/paypal-checkout-components/commit/769aad1)), closes [#2456](https://github.com/paypal/paypal-checkout-components/issues/2456)
...
* [ncp] handle create order errors (#2320) ([20c9729](https://github.com/paypal/paypal-checkout-components/commit/20c9729)), closes [#2320](https://github.com/paypal/paypal-checkout-components/issues/2320)
...
* [VMORECOMBO-345]- Venmo App Label (#1792) ([9c8e5f9](https://github.com/paypal/paypal-checkout-components/commit/9c8e5f9)), closes [#1792](https://github.com/paypal/paypal-checkout-components/issues/1792)
...
* Add `enableDPoP` flag for Hosted Buttons (#2340) ([a739ef5](https://github.com/paypal/paypal-checkout-components/commit/a739ef5)), closes [#2340](https://github.com/paypal/paypal-checkout-components/issues/2340)
...
* Add a new sign_out_user prop to zoid checkout component (#2262) ([a19661e](https://github.com/paypal/paypal-checkout-components/commit/a19661e)), closes [#2262](https://github.com/paypal/paypal-checkout-components/issues/2262)
...
* Add a11y attributes to MenuButton (#2051) ([a3d9f9d](https://github.com/paypal/paypal-checkout-components/commit/a3d9f9d)), closes [#2051](https://github.com/paypal/paypal-checkout-components/issues/2051)
...
* add additional query param integration_artifact (#2550) ([3c39234](https://github.com/paypal/paypal-checkout-components/commit/3c39234)), closes [#2550](https://github.com/paypal/paypal-checkout-components/issues/2550)
...
* Add and Use PayPal Open Font (#2315) ([536633c](https://github.com/paypal/paypal-checkout-components/commit/536633c)), closes [#2315](https://github.com/paypal/paypal-checkout-components/issues/2315)
...
* Add animation experiment for logo and label text (#1738) ([30544a3](https://github.com/paypal/paypal-checkout-components/commit/30544a3)), closes [#1738](https://github.com/paypal/paypal-checkout-components/issues/1738)
* Add animation tests (#1780) ([0468439](https://github.com/paypal/paypal-checkout-components/commit/0468439)), closes [#1780](https://github.com/paypal/paypal-checkout-components/issues/1780)
* Add another venmo blacklisted domain ([20b1c3b](https://github.com/paypal/paypal-checkout-components/commit/20b1c3b))
* add aria hidden attribute for label container (#2582) ([bb6b6ff](https://github.com/paypal/paypal-checkout-components/commit/bb6b6ff)), closes [#2582](https://github.com/paypal/paypal-checkout-components/issues/2582)
...
* add disable max height changes ([79f33cd](https://github.com/paypal/paypal-checkout-components/commit/79f33cd))
...
* add eligibility check and protect export for stage and local (#2451) ([f0b5eeb](https://github.com/paypal/paypal-checkout-components/commit/f0b5eeb)), closes [#2451](https://github.com/paypal/paypal-checkout-components/issues/2451)
* add eligibility check to children card fields in order to throw more meaningful error messages when  ([f817382](https://github.com/paypal/paypal-checkout-components/commit/f817382)), closes [#2577](https://github.com/paypal/paypal-checkout-components/issues/2577)
...
* Add experiment for the "divide logo animation"  (#1775) ([e1291d3](https://github.com/paypal/paypal-checkout-components/commit/e1291d3)), closes [#1775](https://github.com/paypal/paypal-checkout-components/issues/1775)
...
* add fpti key recommended_payment and pageType for shopper insights (#2324) ([e707ec7](https://github.com/paypal/paypal-checkout-components/commit/e707ec7)), closes [#2324](https://github.com/paypal/paypal-checkout-components/issues/2324)
* Add FPTI Render Events to Card Fields component (#2094) ([f5b6b9d](https://github.com/paypal/paypal-checkout-components/commit/f5b6b9d)), closes [#2094](https://github.com/paypal/paypal-checkout-components/issues/2094)
...
* Add github action for publishing to npm (#1745) ([5729375](https://github.com/paypal/paypal-checkout-components/commit/5729375)), closes [#1745](https://github.com/paypal/paypal-checkout-components/issues/1745)
...
* add idtoken as substitute sdk-client-token (#2495) ([53c9b5f](https://github.com/paypal/paypal-checkout-components/commit/53c9b5f)), closes [#2495](https://github.com/paypal/paypal-checkout-components/issues/2495)
...
* Add isButtonColorABTestMerchant to style prop (#2502) ([cdaca40](https://github.com/paypal/paypal-checkout-components/commit/cdaca40)), closes [#2502](https://github.com/paypal/paypal-checkout-components/issues/2502)
...
* Add Liberation Sans as fallback font (#2325) ([1ca6206](https://github.com/paypal/paypal-checkout-components/commit/1ca6206)), closes [#2325](https://github.com/paypal/paypal-checkout-components/issues/2325)
...
* Add multiblanco payment method (#1825) ([90636ca](https://github.com/paypal/paypal-checkout-components/commit/90636ca)), closes [#1825](https://github.com/paypal/paypal-checkout-components/issues/1825)
...
* add new function to toggle between paypal and pp logo depending on button size ([0ff5ae5](https://github.com/paypal/paypal-checkout-components/commit/0ff5ae5))
...
* Add new prop for Inline XO (#1887) ([3ca6175](https://github.com/paypal/paypal-checkout-components/commit/3ca6175)), closes [#1887](https://github.com/paypal/paypal-checkout-components/issues/1887)
...
* Add PayPal App Switch Overlay (#2484) ([8980daa](https://github.com/paypal/paypal-checkout-components/commit/8980daa)), closes [#2484](https://github.com/paypal/paypal-checkout-components/issues/2484)
...
* Add rebranded Credit Button (#2552) ([de89c0c](https://github.com/paypal/paypal-checkout-components/commit/de89c0c)), closes [#2552](https://github.com/paypal/paypal-checkout-components/issues/2552)
* Add rebranded Pay Later button (#2551) ([f411831](https://github.com/paypal/paypal-checkout-components/commit/f411831)), closes [#2551](https://github.com/paypal/paypal-checkout-components/issues/2551)
* Add rebranded Venmo button (#2553) ([73e157c](https://github.com/paypal/paypal-checkout-components/commit/73e157c)), closes [#2553](https://github.com/paypal/paypal-checkout-components/issues/2553)
...
* Add section for documented related changes (#1749) ([28537a7](https://github.com/paypal/paypal-checkout-components/commit/28537a7)), closes [#1749](https://github.com/paypal/paypal-checkout-components/issues/1749)
...
* Add shopperInsightsUsed xprop 👾 (#2401) ([8698034](https://github.com/paypal/paypal-checkout-components/commit/8698034)), closes [#2401](https://github.com/paypal/paypal-checkout-components/issues/2401)
...
* add start script (#2042) ([da46c07](https://github.com/paypal/paypal-checkout-components/commit/da46c07)), closes [#2042](https://github.com/paypal/paypal-checkout-components/issues/2042)
...
* Added option to set a dynamic height for the card-field prerender component (#1748) ([37482ad](https://github.com/paypal/paypal-checkout-components/commit/37482ad)), closes [#1748](https://github.com/paypal/paypal-checkout-components/issues/1748)
...
* Apple Pay: Prevent Pre-render Click (#1866) ([ee3597d](https://github.com/paypal/paypal-checkout-components/commit/ee3597d)), closes [#1866](https://github.com/paypal/paypal-checkout-components/issues/1866)
...
* Appswitch web fallback return flow (#2477) ([a685a19](https://github.com/paypal/paypal-checkout-components/commit/a685a19)), closes [#2477](https://github.com/paypal/paypal-checkout-components/issues/2477)
...
* bump grumbler-scripts (#1801) ([94990d8](https://github.com/paypal/paypal-checkout-components/commit/94990d8)), closes [#1801](https://github.com/paypal/paypal-checkout-components/issues/1801)
...
* Button Redesign: Colors 👾 (#2317) ([d597263](https://github.com/paypal/paypal-checkout-components/commit/d597263)), closes [#2317](https://github.com/paypal/paypal-checkout-components/issues/2317)
...
* button xprops for app switch support (#2455) ([890d4b0](https://github.com/paypal/paypal-checkout-components/commit/890d4b0)), closes [#2455](https://github.com/paypal/paypal-checkout-components/issues/2455)
...
* change jsx extension to js for file with no jsx (#2305) ([4655801](https://github.com/paypal/paypal-checkout-components/commit/4655801)), closes [#2305](https://github.com/paypal/paypal-checkout-components/issues/2305)
...
* clean up overlay after each test case (#2580) ([80601cb](https://github.com/paypal/paypal-checkout-components/commit/80601cb)), closes [#2580](https://github.com/paypal/paypal-checkout-components/issues/2580)
...
* clean up use of globalSessionID, as we are now leveraging getPayPalSessionID (#2571) ([10bef36](https://github.com/paypal/paypal-checkout-components/commit/10bef36)), closes [#2571](https://github.com/paypal/paypal-checkout-components/issues/2571)
...
* Create new `npm run release` workflow (#1849) ([c810884](https://github.com/paypal/paypal-checkout-components/commit/c810884)), closes [#1849](https://github.com/paypal/paypal-checkout-components/issues/1849)
...
* credit button should not render labels for redesign ([cae725b](https://github.com/paypal/paypal-checkout-components/commit/cae725b))
...
* Don't require onEscapePath ([60aa082](https://github.com/paypal/paypal-checkout-components/commit/60aa082))
...
* Dtppcpsdk 1452 - Pass env to platformOptions (#2300) ([2d3970b](https://github.com/paypal/paypal-checkout-components/commit/2d3970b)), closes [#2300](https://github.com/paypal/paypal-checkout-components/issues/2300)
* DTPPCPSDK-2227: Return V2 Variables from getHostedButtonDetails 👾 (#2385) ([b7f986a](https://github.com/paypal/paypal-checkout-components/commit/b7f986a)), closes [#2385](https://github.com/paypal/paypal-checkout-components/issues/2385)
...
* enable 3DS for prod and sandbox (#2473) ([3fbc7de](https://github.com/paypal/paypal-checkout-components/commit/3fbc7de)), closes [#2473](https://github.com/paypal/paypal-checkout-components/issues/2473)
...
* enable paylater button for Austria as per eligibility ([b5d9e07](https://github.com/paypal/paypal-checkout-components/commit/b5d9e07))
* enable paylater button styling for AT and add UTs, ITs, Screenshot tests and percy tests changes ([7489b51](https://github.com/paypal/paypal-checkout-components/commit/7489b51))
...
* feat (3ds): remove LSAT and utilize sdk token (#2463) ([915822c](https://github.com/paypal/paypal-checkout-components/commit/915822c)), closes [#2463](https://github.com/paypal/paypal-checkout-components/issues/2463)
...
* feature(card-form) add v2 shipping callbacks to card form props (#2428) ([ea7fa2d](https://github.com/paypal/paypal-checkout-components/commit/ea7fa2d)), closes [#2428](https://github.com/paypal/paypal-checkout-components/issues/2428)
* Feature/add disable prerender option (#2413) ([c9ab018](https://github.com/paypal/paypal-checkout-components/commit/c9ab018)), closes [#2413](https://github.com/paypal/paypal-checkout-components/issues/2413)
...
* Feature/enable rebrand smart stack (#2558) ([5de7b90](https://github.com/paypal/paypal-checkout-components/commit/5de7b90)), closes [#2558](https://github.com/paypal/paypal-checkout-components/issues/2558)
...
* Feature/tests for rebrand buttons (#2481) ([281999f](https://github.com/paypal/paypal-checkout-components/commit/281999f)), closes [#2481](https://github.com/paypal/paypal-checkout-components/issues/2481)
* Feature/update card button (#2547) ([98f4be2](https://github.com/paypal/paypal-checkout-components/commit/98f4be2)), closes [#2547](https://github.com/paypal/paypal-checkout-components/issues/2547)
...
* fix animation for smallest button size (#1782) ([8074a8c](https://github.com/paypal/paypal-checkout-components/commit/8074a8c)), closes [#1782](https://github.com/paypal/paypal-checkout-components/issues/1782)
...
* Fix BundleMon configuration (#1781) ([18f0371](https://github.com/paypal/paypal-checkout-components/commit/18f0371)), closes [#1781](https://github.com/paypal/paypal-checkout-components/issues/1781)
...
* fix Error: Expected client-id parameter in sdk url (#2338) ([653f617](https://github.com/paypal/paypal-checkout-components/commit/653f617)), closes [#2338](https://github.com/paypal/paypal-checkout-components/issues/2338)
...
* Fix flow by ignoring 'resolve' node dep (#1828) ([b1644ef](https://github.com/paypal/paypal-checkout-components/commit/b1644ef))
...
* Fix for hosted card fields reinitialization issue. (#2077) ([29b8db4](https://github.com/paypal/paypal-checkout-components/commit/29b8db4)), closes [#2077](https://github.com/paypal/paypal-checkout-components/issues/2077)
* Fix for hybrid startflow ([0dd5d5f](https://github.com/paypal/paypal-checkout-components/commit/0dd5d5f))
* Fix for NCP height string to number conversion 👾 (#2386) ([fd0b814](https://github.com/paypal/paypal-checkout-components/commit/fd0b814)), closes [#2386](https://github.com/paypal/paypal-checkout-components/issues/2386)
...
* fix lint errors ([c7b8e88](https://github.com/paypal/paypal-checkout-components/commit/c7b8e88))
...
* fix locales issue (#1789) ([76baac3](https://github.com/paypal/paypal-checkout-components/commit/76baac3)), closes [#1789](https://github.com/paypal/paypal-checkout-components/issues/1789)
...
* Fix logging for venmo experiment (#1763) ([4a60c91](https://github.com/paypal/paypal-checkout-components/commit/4a60c91)), closes [#1763](https://github.com/paypal/paypal-checkout-components/issues/1763)
...
* fix missing aria-label (#2190) ([de70f4d](https://github.com/paypal/paypal-checkout-components/commit/de70f4d)), closes [#2190](https://github.com/paypal/paypal-checkout-components/issues/2190) [#2169](https://github.com/paypal/paypal-checkout-components/issues/2169)
...
* Fix Percy Screenshot CI Failure (#2255) ([e628f02](https://github.com/paypal/paypal-checkout-components/commit/e628f02)), closes [#2255](https://github.com/paypal/paypal-checkout-components/issues/2255)
...
* Fix Release Job Tagging Issue (#2536) ([3ea5899](https://github.com/paypal/paypal-checkout-components/commit/3ea5899)), closes [#2536](https://github.com/paypal/paypal-checkout-components/issues/2536)
...
* Fix screenshots ([c933975](https://github.com/paypal/paypal-checkout-components/commit/c933975))
...
* Get dpop from form-fields api (#2398) ([6e64e8a](https://github.com/paypal/paypal-checkout-components/commit/6e64e8a)), closes [#2398](https://github.com/paypal/paypal-checkout-components/issues/2398)
...
* handle window closure action on popup bridge (#2544) ([b3292af](https://github.com/paypal/paypal-checkout-components/commit/b3292af)), closes [#2544](https://github.com/paypal/paypal-checkout-components/issues/2544)
...
* height should be set if it is user provided (#2548) ([59c14c9](https://github.com/paypal/paypal-checkout-components/commit/59c14c9)), closes [#2548](https://github.com/paypal/paypal-checkout-components/issues/2548)
* Hide the menu-button under 250px (#1760) ([dd95e41](https://github.com/paypal/paypal-checkout-components/commit/dd95e41)), closes [#1760](https://github.com/paypal/paypal-checkout-components/issues/1760)
...
* Hosted buttons component (#2276) ([5bb0cef](https://github.com/paypal/paypal-checkout-components/commit/5bb0cef)), closes [#2276](https://github.com/paypal/paypal-checkout-components/issues/2276)
...
* Implement latest card fields interface ([6a59a96](https://github.com/paypal/paypal-checkout-components/commit/6a59a96))
...
* Improve venmo conversion based on browsers (#1816) ([634b5c2](https://github.com/paypal/paypal-checkout-components/commit/634b5c2)), closes [#1816](https://github.com/paypal/paypal-checkout-components/issues/1816)
...
* Increase limit to 75kb (#1764) ([8ab9ce9](https://github.com/paypal/paypal-checkout-components/commit/8ab9ce9)), closes [#1764](https://github.com/paypal/paypal-checkout-components/issues/1764)
...
* Inline XO: Alpha eligibility (#1950) ([ea19c7b](https://github.com/paypal/paypal-checkout-components/commit/ea19c7b)), closes [#1950](https://github.com/paypal/paypal-checkout-components/issues/1950)
* Inline XO: Default alpha eligibility to true ([bf2a846](https://github.com/paypal/paypal-checkout-components/commit/bf2a846))
...
* interface changes for standalone card vault (#2085) ([dcd9277](https://github.com/paypal/paypal-checkout-components/commit/dcd9277)), closes [#2085](https://github.com/paypal/paypal-checkout-components/issues/2085)
...
* Log SDK Integration Source (#2329) ([0408bb3](https://github.com/paypal/paypal-checkout-components/commit/0408bb3)), closes [#2329](https://github.com/paypal/paypal-checkout-components/issues/2329)
...
* Make getShopperInsightsUsed prop not required (#2414) ([efb0566](https://github.com/paypal/paypal-checkout-components/commit/efb0566)), closes [#2414](https://github.com/paypal/paypal-checkout-components/issues/2414)
...
* Make one-click UI ineligible if any shipping callback is present 👾 (#2409) ([9b1ff0b](https://github.com/paypal/paypal-checkout-components/commit/9b1ff0b)), closes [#2409](https://github.com/paypal/paypal-checkout-components/issues/2409)
...
* Make scripts prettier (#1854) ([3703ccd](https://github.com/paypal/paypal-checkout-components/commit/3703ccd)), closes [#1854](https://github.com/paypal/paypal-checkout-components/issues/1854)
...
* Memoize Shopper Insights API Call (#2307) ([49dc1cf](https://github.com/paypal/paypal-checkout-components/commit/49dc1cf)), closes [#2307](https://github.com/paypal/paypal-checkout-components/issues/2307)
* Menu Placement Style Prop for MenuButtons (#1839) ([d91072c](https://github.com/paypal/paypal-checkout-components/commit/d91072c)), closes [#1839](https://github.com/paypal/paypal-checkout-components/issues/1839)
...
* move pull request template to .github root (#1743) ([1c3ed4a](https://github.com/paypal/paypal-checkout-components/commit/1c3ed4a)), closes [#1743](https://github.com/paypal/paypal-checkout-components/issues/1743)
...
* ncps - expand inline guest (#2356) ([82af8b4](https://github.com/paypal/paypal-checkout-components/commit/82af8b4)), closes [#2356](https://github.com/paypal/paypal-checkout-components/issues/2356)
...
* New Card Fields: Refactor data returned in onChange callback (#2055) ([5ac3cfe](https://github.com/paypal/paypal-checkout-components/commit/5ac3cfe)), closes [#2055](https://github.com/paypal/paypal-checkout-components/issues/2055) [#1967](https://github.com/paypal/paypal-checkout-components/issues/1967) [#1978](https://github.com/paypal/paypal-checkout-components/issues/1978) [#1987](https://github.com/paypal/paypal-checkout-components/issues/1987) [#2007](https://github.com/paypal/paypal-checkout-components/issues/2007) [#2027](https://github.com/paypal/paypal-checkout-components/issues/2027) [#2033](https://github.com/paypal/paypal-checkout-components/issues/2033)
...
* Pass cmid as sessionId is there is no cmid passed from merchant (#2306) ([ffef152](https://github.com/paypal/paypal-checkout-components/commit/ffef152)), closes [#2306](https://github.com/paypal/paypal-checkout-components/issues/2306)
...
* Pass locale to NCP team 👾 (#2374) ([0aab954](https://github.com/paypal/paypal-checkout-components/commit/0aab954)), closes [#2374](https://github.com/paypal/paypal-checkout-components/issues/2374)
...
* Pin latest version of @percy/cli (#2379) ([dd732ac](https://github.com/paypal/paypal-checkout-components/commit/dd732ac)), closes [#2379](https://github.com/paypal/paypal-checkout-components/issues/2379)
...
* PPoF a11y (#2048) ([cab6670](https://github.com/paypal/paypal-checkout-components/commit/cab6670)), closes [#2048](https://github.com/paypal/paypal-checkout-components/issues/2048)
...
* Put instrument label in span to allow for overflow ellipsis ([d85403b](https://github.com/paypal/paypal-checkout-components/commit/d85403b))
...
* ramp experiment for paylater on/off (#1771) ([885f0f8](https://github.com/paypal/paypal-checkout-components/commit/885f0f8)), closes [#1771](https://github.com/paypal/paypal-checkout-components/issues/1771)
* ramp experiment to 1% (#1751) ([713c2ea](https://github.com/paypal/paypal-checkout-components/commit/713c2ea)), closes [#1751](https://github.com/paypal/paypal-checkout-components/issues/1751)
...
* Re-add Shopper Insights (#2354) ([f6d2c28](https://github.com/paypal/paypal-checkout-components/commit/f6d2c28)), closes [#2354](https://github.com/paypal/paypal-checkout-components/issues/2354)
...
* Rebranded PayPal button (#2543) ([5b888ee](https://github.com/paypal/paypal-checkout-components/commit/5b888ee)), closes [#2543](https://github.com/paypal/paypal-checkout-components/issues/2543)
* redirect method in button props (#2467) ([bebcb3f](https://github.com/paypal/paypal-checkout-components/commit/bebcb3f)), closes [#2467](https://github.com/paypal/paypal-checkout-components/issues/2467)
* redirect ncps inline guest with errors (#2373) ([d4d5080](https://github.com/paypal/paypal-checkout-components/commit/d4d5080)), closes [#2373](https://github.com/paypal/paypal-checkout-components/issues/2373)
...
* redo actions and scripts (#1999) ([ffc629b](https://github.com/paypal/paypal-checkout-components/commit/ffc629b)), closes [#1999](https://github.com/paypal/paypal-checkout-components/issues/1999)
* Reduce margin for vault header ([1e5811d](https://github.com/paypal/paypal-checkout-components/commit/1e5811d))
* Reduce max width for vault button label ([5a9e16d](https://github.com/paypal/paypal-checkout-components/commit/5a9e16d))
* Reduce redirect delay for legacy ([abb24c1](https://github.com/paypal/paypal-checkout-components/commit/abb24c1))
* Reduce size and impact of vault button divider ([452a3b4](https://github.com/paypal/paypal-checkout-components/commit/452a3b4))
...
* Refactor button personalization design (#1793) ([bd84b80](https://github.com/paypal/paypal-checkout-components/commit/bd84b80)), closes [#1793](https://github.com/paypal/paypal-checkout-components/issues/1793)
...
* remove button size from prerendered props (#1787) ([c85722b](https://github.com/paypal/paypal-checkout-components/commit/c85722b)), closes [#1787](https://github.com/paypal/paypal-checkout-components/issues/1787)
...
* Remove getRecommendedPaymentMethods() (#2331) ([0acc0a1](https://github.com/paypal/paypal-checkout-components/commit/0acc0a1)), closes [#2331](https://github.com/paypal/paypal-checkout-components/issues/2331)
...
* Remove isPayPalDomain from subscriptions props (#2568) ([5937a2c](https://github.com/paypal/paypal-checkout-components/commit/5937a2c)), closes [#2568](https://github.com/paypal/paypal-checkout-components/issues/2568)
...
* Remove line break from installment label (#2542) ([0e53d1f](https://github.com/paypal/paypal-checkout-components/commit/0e53d1f)), closes [#2542](https://github.com/paypal/paypal-checkout-components/issues/2542)
...
* Remove Postal Code from CardFields (#2131) ([fb17cea](https://github.com/paypal/paypal-checkout-components/commit/fb17cea)), closes [#2131](https://github.com/paypal/paypal-checkout-components/issues/2131)
...
* Remove QR spinner to wait for SPB (#1786) ([333ff43](https://github.com/paypal/paypal-checkout-components/commit/333ff43)), closes [#1786](https://github.com/paypal/paypal-checkout-components/issues/1786)
...
* Render Debit or Credit Card when `style.layout` is "horizontal" (#2346) ([cb3d943](https://github.com/paypal/paypal-checkout-components/commit/cb3d943)), closes [#2346](https://github.com/paypal/paypal-checkout-components/issues/2346)
...
* Require onEscapePath ([cb2e325](https://github.com/paypal/paypal-checkout-components/commit/cb2e325))
...
* Revert "Fix Release Job Tagging Issue (#2536)" (#2537) ([0bed676](https://github.com/paypal/paypal-checkout-components/commit/0bed676)), closes [#2536](https://github.com/paypal/paypal-checkout-components/issues/2536) [#2537](https://github.com/paypal/paypal-checkout-components/issues/2537)
...
* Revert "Reduce popup dimension" ([2672d87](https://github.com/paypal/paypal-checkout-components/commit/2672d87))
...
* run vitest in ci (#2345) ([d3caea9](https://github.com/paypal/paypal-checkout-components/commit/d3caea9)), closes [#2345](https://github.com/paypal/paypal-checkout-components/issues/2345)
...
* s/ZalgoPromise/Promise (#2337) ([2fb3820](https://github.com/paypal/paypal-checkout-components/commit/2fb3820)), closes [#2337](https://github.com/paypal/paypal-checkout-components/issues/2337)
...
* save action (#2044) ([93856dc](https://github.com/paypal/paypal-checkout-components/commit/93856dc)), closes [#2044](https://github.com/paypal/paypal-checkout-components/issues/2044) [#2046](https://github.com/paypal/paypal-checkout-components/issues/2046) [#2047](https://github.com/paypal/paypal-checkout-components/issues/2047)
* save methods (#2086) ([218731e](https://github.com/paypal/paypal-checkout-components/commit/218731e)), closes [#2086](https://github.com/paypal/paypal-checkout-components/issues/2086)
...
* Sending globalSessionID as a prop to button component (#2534) ([602f5c9](https://github.com/paypal/paypal-checkout-components/commit/602f5c9)), closes [#2534](https://github.com/paypal/paypal-checkout-components/issues/2534)
...
* set hasShippingCallback in checkout web url if shipping callbacks are used (#2494) ([ce7a301](https://github.com/paypal/paypal-checkout-components/commit/ce7a301)), closes [#2494](https://github.com/paypal/paypal-checkout-components/issues/2494)
...
* set referrerDomain in xprops (#2296) ([b17c54f](https://github.com/paypal/paypal-checkout-components/commit/b17c54f)), closes [#2296](https://github.com/paypal/paypal-checkout-components/issues/2296)
...
* set window.outerHeight on venmo eligibility test (#2172) ([4b918a7](https://github.com/paypal/paypal-checkout-components/commit/4b918a7)), closes [#2172](https://github.com/paypal/paypal-checkout-components/issues/2172)
...
* skip url validation for local (#2474) ([6dad53d](https://github.com/paypal/paypal-checkout-components/commit/6dad53d)), closes [#2474](https://github.com/paypal/paypal-checkout-components/issues/2474)
...
* Support payIn3 labels (#1826) ([596b50e](https://github.com/paypal/paypal-checkout-components/commit/596b50e)), closes [#1826](https://github.com/paypal/paypal-checkout-components/issues/1826)
...
* support shipping callbacks for Hosted Buttons (#2411) ([f912cfc](https://github.com/paypal/paypal-checkout-components/commit/f912cfc)), closes [#2411](https://github.com/paypal/paypal-checkout-components/issues/2411)
...
* Temporarily remove jest-screenshot command from main workflow 👾 (#2321) ([ee3931a](https://github.com/paypal/paypal-checkout-components/commit/ee3931a)), closes [#2321](https://github.com/paypal/paypal-checkout-components/issues/2321)
...
* Test script for paylater button eligibility validation for any geolocation along with script usage i ([f838996](https://github.com/paypal/paypal-checkout-components/commit/f838996))
...
* turn off pay later experiment (#1794) ([ed71540](https://github.com/paypal/paypal-checkout-components/commit/ed71540)), closes [#1794](https://github.com/paypal/paypal-checkout-components/issues/1794)
...
* Update babel-node scripts (#2400) ([9cb72c6](https://github.com/paypal/paypal-checkout-components/commit/9cb72c6)), closes [#2400](https://github.com/paypal/paypal-checkout-components/issues/2400)
...
* update component name, fix success state response (#2466) ([76df556](https://github.com/paypal/paypal-checkout-components/commit/76df556)), closes [#2466](https://github.com/paypal/paypal-checkout-components/issues/2466)
...
* Update hosted buttons funding source mapping (#2314) ([18cd546](https://github.com/paypal/paypal-checkout-components/commit/18cd546)), closes [#2314](https://github.com/paypal/paypal-checkout-components/issues/2314)
* Update hover states to work with touch input devices (#1788) ([6c251af](https://github.com/paypal/paypal-checkout-components/commit/6c251af)), closes [#1788](https://github.com/paypal/paypal-checkout-components/issues/1788)
...
* update imported logo name and have DE credit map to german paylater text ([9b4e931](https://github.com/paypal/paypal-checkout-components/commit/9b4e931))
* Update info logs (#2405) ([7f6e3d2](https://github.com/paypal/paypal-checkout-components/commit/7f6e3d2)), closes [#2405](https://github.com/paypal/paypal-checkout-components/issues/2405)
* Update Inline XO eligibility (#1964) ([53214cc](https://github.com/paypal/paypal-checkout-components/commit/53214cc)), closes [#1964](https://github.com/paypal/paypal-checkout-components/issues/1964)
...
* Update optional children rendering logic (#2501) ([96ff258](https://github.com/paypal/paypal-checkout-components/commit/96ff258)), closes [#2501](https://github.com/paypal/paypal-checkout-components/issues/2501)
...
* Update PR template (#1750) ([1adbb59](https://github.com/paypal/paypal-checkout-components/commit/1adbb59)), closes [#1750](https://github.com/paypal/paypal-checkout-components/issues/1750)
...
* Update pre-render template to take the height of the input selector (#2417) ([c3d693a](https://github.com/paypal/paypal-checkout-components/commit/c3d693a)), closes [#2417](https://github.com/paypal/paypal-checkout-components/issues/2417)
...
* Update README.md to add issue link ([069589f](https://github.com/paypal/paypal-checkout-components/commit/069589f))
* Update renovate.json ([48c32ee](https://github.com/paypal/paypal-checkout-components/commit/48c32ee))
* update resume flow contract (#2461) ([df7a515](https://github.com/paypal/paypal-checkout-components/commit/df7a515)), closes [#2461](https://github.com/paypal/paypal-checkout-components/issues/2461)
* update return url query params (#2483) ([b700997](https://github.com/paypal/paypal-checkout-components/commit/b700997)), closes [#2483](https://github.com/paypal/paypal-checkout-components/issues/2483)
...
* update the BT min Version, add patchVersion + update unit test (#2435) ([05f95db](https://github.com/paypal/paypal-checkout-components/commit/05f95db)), closes [#2435](https://github.com/paypal/paypal-checkout-components/issues/2435)
...
* Update valid button labels for ac (#1983) ([d1428a5](https://github.com/paypal/paypal-checkout-components/commit/d1428a5)), closes [#1983](https://github.com/paypal/paypal-checkout-components/issues/1983)
...
* Update/font family redesign (#2498) ([77f4240](https://github.com/paypal/paypal-checkout-components/commit/77f4240)), closes [#2498](https://github.com/paypal/paypal-checkout-components/issues/2498)
...
* Updated NCPS buttons to accept rebrand (#2562) ([a2744c5](https://github.com/paypal/paypal-checkout-components/commit/a2744c5)), closes [#2562](https://github.com/paypal/paypal-checkout-components/issues/2562)
...
* updating .nvmrc to 16.18 (#2291) ([5f4feef](https://github.com/paypal/paypal-checkout-components/commit/5f4feef)), closes [#2291](https://github.com/paypal/paypal-checkout-components/issues/2291)
...
* upgrade vitest (#2343) ([6707d29](https://github.com/paypal/paypal-checkout-components/commit/6707d29)), closes [#2343](https://github.com/paypal/paypal-checkout-components/issues/2343)
...
* upload and report code coverage for vitest tests (#2344) ([11efea6](https://github.com/paypal/paypal-checkout-components/commit/11efea6)), closes [#2344](https://github.com/paypal/paypal-checkout-components/issues/2344)
...
* use current sha in alpha tag (#2364) ([78c6588](https://github.com/paypal/paypal-checkout-components/commit/78c6588)), closes [#2364](https://github.com/paypal/paypal-checkout-components/issues/2364)
...
* Validate braintree version and default cmid to sessionId if null (#2302) ([5d0ab66](https://github.com/paypal/paypal-checkout-components/commit/5d0ab66)), closes [#2302](https://github.com/paypal/paypal-checkout-components/issues/2302)
...
* validate sdk-token required in getRecommendedPaymentMethods() method (#2311) ([1172445](https://github.com/paypal/paypal-checkout-components/commit/1172445)), closes [#2311](https://github.com/paypal/paypal-checkout-components/issues/2311)
...
* Venmo Desktop - Consumer Feedback collection (#1747) ([4af8222](https://github.com/paypal/paypal-checkout-components/commit/4af8222)), closes [#1747](https://github.com/paypal/paypal-checkout-components/issues/1747)
...
* chore: add cdn experiment logStart (#2088) ([fb24507](https://github.com/paypal/paypal-checkout-components/commit/fb24507)), closes [#2088](https://github.com/paypal/paypal-checkout-components/issues/2088)
...
* chore: fix local dev script (#2045) ([7481dd1](https://github.com/paypal/paypal-checkout-components/commit/7481dd1)), closes [#2045](https://github.com/paypal/paypal-checkout-components/issues/2045)
...
* chore: prettier (#2118) ([84a5a5e](https://github.com/paypal/paypal-checkout-components/commit/84a5a5e)), closes [#2118](https://github.com/paypal/paypal-checkout-components/issues/2118)
* chore: ramp logo cdn experiment (#2093) ([517b575](https://github.com/paypal/paypal-checkout-components/commit/517b575)), closes [#2093](https://github.com/paypal/paypal-checkout-components/issues/2093)
* chore: ramp logo experiment (#2108) ([4866465](https://github.com/paypal/paypal-checkout-components/commit/4866465)), closes [#2108](https://github.com/paypal/paypal-checkout-components/issues/2108)
* chore: ramp logos experiment to 100% (#2111) ([b14f69d](https://github.com/paypal/paypal-checkout-components/commit/b14f69d)), closes [#2111](https://github.com/paypal/paypal-checkout-components/issues/2111)
* chore: ramp venmo experiment to 100 percent (#1945) ([5866842](https://github.com/paypal/paypal-checkout-components/commit/5866842)), closes [#1945](https://github.com/paypal/paypal-checkout-components/issues/1945)
...
* chore: remove isInlineXOEligible log (#2087) ([ea49c60](https://github.com/paypal/paypal-checkout-components/commit/ea49c60)), closes [#2087](https://github.com/paypal/paypal-checkout-components/issues/2087)
...
* chore: remove unused 'no paylater' experiment code (#1958) ([dcfb917](https://github.com/paypal/paypal-checkout-components/commit/dcfb917)), closes [#1958](https://github.com/paypal/paypal-checkout-components/issues/1958)
* chore: remove unused quickbuild script (#1961) ([a94bbda](https://github.com/paypal/paypal-checkout-components/commit/a94bbda)), closes [#1961](https://github.com/paypal/paypal-checkout-components/issues/1961)
...
* chore: update bank glyph screenshots (#2078) ([0483bf5](https://github.com/paypal/paypal-checkout-components/commit/0483bf5)), closes [#2078](https://github.com/paypal/paypal-checkout-components/issues/2078)
* chore: update bundlesize tracking to use bundlemon (#1765) ([4a56c9e](https://github.com/paypal/paypal-checkout-components/commit/4a56c9e)), closes [#1765](https://github.com/paypal/paypal-checkout-components/issues/1765)
...
* chore: update default branch to main (#1856) ([56afff1](https://github.com/paypal/paypal-checkout-components/commit/56afff1)), closes [#1856](https://github.com/paypal/paypal-checkout-components/issues/1856)
...
* chore: upgrade to grumbler-scripts v5 (#1797) ([e150306](https://github.com/paypal/paypal-checkout-components/commit/e150306)), closes [#1797](https://github.com/paypal/paypal-checkout-components/issues/1797)
...
* chore(deps): bump version of grumbler-scripts (#2168) ([92ea2f9](https://github.com/paypal/paypal-checkout-components/commit/92ea2f9)), closes [#2168](https://github.com/paypal/paypal-checkout-components/issues/2168)
* chore(deps): ignore flow-bin updates (#1886) ([c0b9d93](https://github.com/paypal/paypal-checkout-components/commit/c0b9d93)), closes [#1886](https://github.com/paypal/paypal-checkout-components/issues/1886)
...
* chore(deps): update dependency angular.js to v1.8.2 (#1830) ([63e65f8](https://github.com/paypal/paypal-checkout-components/commit/63e65f8)), closes [#1830](https://github.com/paypal/paypal-checkout-components/issues/1830)
...
* chore(deps): update dependency fs-extra to v10 (#1832) ([ce2b35f](https://github.com/paypal/paypal-checkout-components/commit/ce2b35f)), closes [#1832](https://github.com/paypal/paypal-checkout-components/issues/1832)
...
* chore(deps): update dependency lint-staged to v13 (#1949) ([7e1bb6d](https://github.com/paypal/paypal-checkout-components/commit/7e1bb6d)), closes [#1949](https://github.com/paypal/paypal-checkout-components/issues/1949)
* chore(deps): update dependency mocha to v10 (#1932) ([c70f2e3](https://github.com/paypal/paypal-checkout-components/commit/c70f2e3)), closes [#1932](https://github.com/paypal/paypal-checkout-components/issues/1932)
...
* chore(deps): update dependency serve to v13 (#1785) ([3a2fae6](https://github.com/paypal/paypal-checkout-components/commit/3a2fae6)), closes [#1785](https://github.com/paypal/paypal-checkout-components/issues/1785)
* chore(deps): update dependency serve to v14 (#1965) ([7df280c](https://github.com/paypal/paypal-checkout-components/commit/7df280c)), closes [#1965](https://github.com/paypal/paypal-checkout-components/issues/1965)
...
* chore(docs): fix github actions badge (#2056) ([4cd369e](https://github.com/paypal/paypal-checkout-components/commit/4cd369e)), closes [#2056](https://github.com/paypal/paypal-checkout-components/issues/2056)
* chore(documentation): Add PR Template (#1735) ([e042256](https://github.com/paypal/paypal-checkout-components/commit/e042256)), closes [#1735](https://github.com/paypal/paypal-checkout-components/issues/1735)
* chore(documentation): update contributing link in pr template (#1744) ([c647e2f](https://github.com/paypal/paypal-checkout-components/commit/c647e2f)), closes [#1744](https://github.com/paypal/paypal-checkout-components/issues/1744)
* chore(release): 5.0.1 :tada: ([6ddab93](https://github.com/paypal/paypal-checkout-components/commit/6ddab93))
* chore(release): 5.0.10 :tada: ([c5c1b86](https://github.com/paypal/paypal-checkout-components/commit/c5c1b86))
* chore(release): 5.0.100 :tada: ([9da8914](https://github.com/paypal/paypal-checkout-components/commit/9da8914))
* chore(release): 5.0.101 :tada: ([d60ad0b](https://github.com/paypal/paypal-checkout-components/commit/d60ad0b))
* chore(release): 5.0.102 :tada: ([a551790](https://github.com/paypal/paypal-checkout-components/commit/a551790))
* chore(release): 5.0.103 :tada: ([cc440ac](https://github.com/paypal/paypal-checkout-components/commit/cc440ac))
...
* chore(release): 5.0.11 :tada: ([f272f09](https://github.com/paypal/paypal-checkout-components/commit/f272f09))
...
* chore(release): 5.0.12 :tada: ([c109821](https://github.com/paypal/paypal-checkout-components/commit/c109821))
...
* chore(release): 5.0.13 :tada: ([5de80e7](https://github.com/paypal/paypal-checkout-components/commit/5de80e7))
...
* chore(release): 5.0.14 :tada: ([9327f34](https://github.com/paypal/paypal-checkout-components/commit/9327f34))
...
* chore(release): 5.0.15 :tada: ([fa4bb8a](https://github.com/paypal/paypal-checkout-components/commit/fa4bb8a))
...
* chore(release): 5.0.16 :tada: ([20ff273](https://github.com/paypal/paypal-checkout-components/commit/20ff273))
...
* chore(release): 5.0.17 :tada: ([cb1d14f](https://github.com/paypal/paypal-checkout-components/commit/cb1d14f))
...
* chore(release): 5.0.175 :tada: ([a8e5927](https://github.com/paypal/paypal-checkout-components/commit/a8e5927))
* chore(release): 5.0.176 :tada: ([8ee79bd](https://github.com/paypal/paypal-checkout-components/commit/8ee79bd))
* chore(release): 5.0.177 :tada: ([13fee61](https://github.com/paypal/paypal-checkout-components/commit/13fee61))
* chore(release): 5.0.178 :tada: ([376a089](https://github.com/paypal/paypal-checkout-components/commit/376a089))
* chore(release): 5.0.179 :tada: ([c4cc305](https://github.com/paypal/paypal-checkout-components/commit/c4cc305))
* chore(release): 5.0.18 :tada: ([9bc8844](https://github.com/paypal/paypal-checkout-components/commit/9bc8844))
...
* chore(release): 5.0.182 :tada: ([c8ff710](https://github.com/paypal/paypal-checkout-components/commit/c8ff710))
* chore(release): 5.0.183 :tada: ([c76d755](https://github.com/paypal/paypal-checkout-components/commit/c76d755))
* chore(release): 5.0.184 :tada: ([5733a85](https://github.com/paypal/paypal-checkout-components/commit/5733a85))
* chore(release): 5.0.185 :tada: ([b698d98](https://github.com/paypal/paypal-checkout-components/commit/b698d98))
* chore(release): 5.0.186 :tada: ([4cebcf3](https://github.com/paypal/paypal-checkout-components/commit/4cebcf3))
* chore(release): 5.0.187 :tada: ([ecc73e0](https://github.com/paypal/paypal-checkout-components/commit/ecc73e0))
* chore(release): 5.0.188 :tada: ([2b8c6e7](https://github.com/paypal/paypal-checkout-components/commit/2b8c6e7))
* chore(release): 5.0.189 :tada: ([68edd1a](https://github.com/paypal/paypal-checkout-components/commit/68edd1a))
* chore(release): 5.0.19 :tada: ([3efd89f](https://github.com/paypal/paypal-checkout-components/commit/3efd89f))
* chore(release): 5.0.190 🎉 ([eb0db4a](https://github.com/paypal/paypal-checkout-components/commit/eb0db4a))
* chore(release): 5.0.191 🎉 ([dfa5a02](https://github.com/paypal/paypal-checkout-components/commit/dfa5a02))
* chore(release): 5.0.192 🎉 ([6f7d516](https://github.com/paypal/paypal-checkout-components/commit/6f7d516))
* chore(release): 5.0.193 🎉 ([5533d0c](https://github.com/paypal/paypal-checkout-components/commit/5533d0c))
* chore(release): 5.0.194 🎉 ([82daf65](https://github.com/paypal/paypal-checkout-components/commit/82daf65))
* chore(release): 5.0.195 🎉 ([a9cc190](https://github.com/paypal/paypal-checkout-components/commit/a9cc190))
* chore(release): 5.0.196 🎉 ([e5cd9dc](https://github.com/paypal/paypal-checkout-components/commit/e5cd9dc))
* chore(release): 5.0.197 🎉 ([47eecc1](https://github.com/paypal/paypal-checkout-components/commit/47eecc1))
* chore(release): 5.0.198 🎉 ([6333d2f](https://github.com/paypal/paypal-checkout-components/commit/6333d2f))
* chore(release): 5.0.199 🎉 ([90411d6](https://github.com/paypal/paypal-checkout-components/commit/90411d6))
* chore(release): 5.0.2 :tada: ([8761032](https://github.com/paypal/paypal-checkout-components/commit/8761032))
* chore(release): 5.0.20 :tada: ([37d0438](https://github.com/paypal/paypal-checkout-components/commit/37d0438))
* chore(release): 5.0.200 🎉 ([6bc1b83](https://github.com/paypal/paypal-checkout-components/commit/6bc1b83))
* chore(release): 5.0.201 🎉 ([f4f6edc](https://github.com/paypal/paypal-checkout-components/commit/f4f6edc))
* chore(release): 5.0.202 🎉 ([e55848a](https://github.com/paypal/paypal-checkout-components/commit/e55848a))
* chore(release): 5.0.203 🎉 ([105f418](https://github.com/paypal/paypal-checkout-components/commit/105f418))
* chore(release): 5.0.204 🎉 ([0c6c8d3](https://github.com/paypal/paypal-checkout-components/commit/0c6c8d3))
* chore(release): 5.0.205 🎉 ([6cdcd95](https://github.com/paypal/paypal-checkout-components/commit/6cdcd95))
* chore(release): 5.0.206 🎉 ([d9546b2](https://github.com/paypal/paypal-checkout-components/commit/d9546b2))
* chore(release): 5.0.207 🎉 ([67871d8](https://github.com/paypal/paypal-checkout-components/commit/67871d8))
* chore(release): 5.0.208 🎉 ([a7a85f9](https://github.com/paypal/paypal-checkout-components/commit/a7a85f9))
* chore(release): 5.0.209 🎉 ([8122787](https://github.com/paypal/paypal-checkout-components/commit/8122787))
* chore(release): 5.0.21 :tada: ([f841027](https://github.com/paypal/paypal-checkout-components/commit/f841027))
* chore(release): 5.0.210 🎉 ([5709056](https://github.com/paypal/paypal-checkout-components/commit/5709056))
* chore(release): 5.0.211 🎉 ([614a17c](https://github.com/paypal/paypal-checkout-components/commit/614a17c))
* chore(release): 5.0.212 🎉 ([627d7b4](https://github.com/paypal/paypal-checkout-components/commit/627d7b4))
* chore(release): 5.0.213 🎉 ([3160d8f](https://github.com/paypal/paypal-checkout-components/commit/3160d8f))
* chore(release): 5.0.214 🎉 ([9e3c988](https://github.com/paypal/paypal-checkout-components/commit/9e3c988))
* chore(release): 5.0.215 🎉 ([c25a49a](https://github.com/paypal/paypal-checkout-components/commit/c25a49a))
* chore(release): 5.0.216 🎉 ([00dfcfe](https://github.com/paypal/paypal-checkout-components/commit/00dfcfe))
* chore(release): 5.0.217 🎉 ([1d43996](https://github.com/paypal/paypal-checkout-components/commit/1d43996))
* chore(release): 5.0.218 🎉 ([74e35d3](https://github.com/paypal/paypal-checkout-components/commit/74e35d3))
* chore(release): 5.0.219 🎉 ([1e016ad](https://github.com/paypal/paypal-checkout-components/commit/1e016ad))
* chore(release): 5.0.22 :tada: ([ab4679e](https://github.com/paypal/paypal-checkout-components/commit/ab4679e))
* chore(release): 5.0.220 🎉 ([4d4b653](https://github.com/paypal/paypal-checkout-components/commit/4d4b653))
* chore(release): 5.0.221 🎉 ([4dafe5e](https://github.com/paypal/paypal-checkout-components/commit/4dafe5e))
* chore(release): 5.0.222 🎉 ([e751b92](https://github.com/paypal/paypal-checkout-components/commit/e751b92))
* chore(release): 5.0.223 🎉 ([0b8c666](https://github.com/paypal/paypal-checkout-components/commit/0b8c666))
* chore(release): 5.0.224 🎉 ([151c7d4](https://github.com/paypal/paypal-checkout-components/commit/151c7d4))
* chore(release): 5.0.225 🎉 ([94362aa](https://github.com/paypal/paypal-checkout-components/commit/94362aa))
* chore(release): 5.0.226 🎉 ([8e4f0db](https://github.com/paypal/paypal-checkout-components/commit/8e4f0db))
* chore(release): 5.0.227 🎉 ([34cd115](https://github.com/paypal/paypal-checkout-components/commit/34cd115))
* chore(release): 5.0.228 🎉 ([577b1c7](https://github.com/paypal/paypal-checkout-components/commit/577b1c7))
* chore(release): 5.0.229 🎉 ([81ce262](https://github.com/paypal/paypal-checkout-components/commit/81ce262))
* chore(release): 5.0.23 :tada: ([c7f2f64](https://github.com/paypal/paypal-checkout-components/commit/c7f2f64))
* chore(release): 5.0.230 🎉 ([047c91d](https://github.com/paypal/paypal-checkout-components/commit/047c91d))
* chore(release): 5.0.231 🎉 ([79c3476](https://github.com/paypal/paypal-checkout-components/commit/79c3476))
* chore(release): 5.0.232 🎉 ([b39d7d0](https://github.com/paypal/paypal-checkout-components/commit/b39d7d0))
* chore(release): 5.0.233 🎉 ([47c1fd5](https://github.com/paypal/paypal-checkout-components/commit/47c1fd5))
* chore(release): 5.0.234 🎉 ([0b98c6f](https://github.com/paypal/paypal-checkout-components/commit/0b98c6f))
* chore(release): 5.0.235 🎉 ([3095ef5](https://github.com/paypal/paypal-checkout-components/commit/3095ef5))
* chore(release): 5.0.236 🎉 ([5e4cc35](https://github.com/paypal/paypal-checkout-components/commit/5e4cc35))
* chore(release): 5.0.237 🎉 ([b0631dc](https://github.com/paypal/paypal-checkout-components/commit/b0631dc))
...
* chore(release): 5.0.24 :tada: ([bdb8d32](https://github.com/paypal/paypal-checkout-components/commit/bdb8d32))
* chore(release): 5.0.240 🎉 ([1b80daf](https://github.com/paypal/paypal-checkout-components/commit/1b80daf))
* chore(release): 5.0.241 🎉 ([32ab73c](https://github.com/paypal/paypal-checkout-components/commit/32ab73c))
* chore(release): 5.0.242 🎉 ([ecfeac7](https://github.com/paypal/paypal-checkout-components/commit/ecfeac7))
* chore(release): 5.0.243 🎉 ([6261a7c](https://github.com/paypal/paypal-checkout-components/commit/6261a7c))
* chore(release): 5.0.244 🎉 ([c15dbd6](https://github.com/paypal/paypal-checkout-components/commit/c15dbd6))
* chore(release): 5.0.245 🎉 ([169cea9](https://github.com/paypal/paypal-checkout-components/commit/169cea9))
* chore(release): 5.0.246 🎉 ([5bc10aa](https://github.com/paypal/paypal-checkout-components/commit/5bc10aa))
* chore(release): 5.0.247 🎉 ([4e82d1f](https://github.com/paypal/paypal-checkout-components/commit/4e82d1f))
* chore(release): 5.0.248 🎉 ([499480e](https://github.com/paypal/paypal-checkout-components/commit/499480e))
* chore(release): 5.0.249 🎉 ([1fd1537](https://github.com/paypal/paypal-checkout-components/commit/1fd1537))
* chore(release): 5.0.25 :tada: ([c42df58](https://github.com/paypal/paypal-checkout-components/commit/c42df58))
* chore(release): 5.0.250 🎉 ([a03d044](https://github.com/paypal/paypal-checkout-components/commit/a03d044))
* chore(release): 5.0.251 🎉 ([80a674a](https://github.com/paypal/paypal-checkout-components/commit/80a674a))
* chore(release): 5.0.252 🎉 ([386500b](https://github.com/paypal/paypal-checkout-components/commit/386500b))
* chore(release): 5.0.253 🎉 ([d0e4ae2](https://github.com/paypal/paypal-checkout-components/commit/d0e4ae2))
* chore(release): 5.0.254 🎉 ([ee5eb85](https://github.com/paypal/paypal-checkout-components/commit/ee5eb85))
* chore(release): 5.0.255 🎉 ([b29d1ba](https://github.com/paypal/paypal-checkout-components/commit/b29d1ba))
* chore(release): 5.0.256 🎉 ([a4e2a58](https://github.com/paypal/paypal-checkout-components/commit/a4e2a58))
* chore(release): 5.0.257 🎉 ([89df3f8](https://github.com/paypal/paypal-checkout-components/commit/89df3f8))
* chore(release): 5.0.258 🎉 ([c8c40e4](https://github.com/paypal/paypal-checkout-components/commit/c8c40e4))
* chore(release): 5.0.259 🎉 ([92416e8](https://github.com/paypal/paypal-checkout-components/commit/92416e8))
* chore(release): 5.0.26 :tada: ([2b47ff6](https://github.com/paypal/paypal-checkout-components/commit/2b47ff6))
* chore(release): 5.0.260 🎉 ([8f9126e](https://github.com/paypal/paypal-checkout-components/commit/8f9126e))
* chore(release): 5.0.261 🎉 ([1d6b7a1](https://github.com/paypal/paypal-checkout-components/commit/1d6b7a1))
* chore(release): 5.0.262 🎉 ([d704757](https://github.com/paypal/paypal-checkout-components/commit/d704757))
* chore(release): 5.0.263 🎉 ([26de687](https://github.com/paypal/paypal-checkout-components/commit/26de687))
* chore(release): 5.0.264 🎉 ([a562b2f](https://github.com/paypal/paypal-checkout-components/commit/a562b2f))
* chore(release): 5.0.265 🎉 ([2bd96ea](https://github.com/paypal/paypal-checkout-components/commit/2bd96ea))
* chore(release): 5.0.266 🎉 ([de4c26c](https://github.com/paypal/paypal-checkout-components/commit/de4c26c))
* chore(release): 5.0.267 🎉 ([7620301](https://github.com/paypal/paypal-checkout-components/commit/7620301))
* chore(release): 5.0.268 🎉 ([171cbb2](https://github.com/paypal/paypal-checkout-components/commit/171cbb2))
* chore(release): 5.0.269 🎉 ([9763621](https://github.com/paypal/paypal-checkout-components/commit/9763621))
* chore(release): 5.0.27 :tada: ([bf25864](https://github.com/paypal/paypal-checkout-components/commit/bf25864))
* chore(release): 5.0.270 🎉 ([d1896dc](https://github.com/paypal/paypal-checkout-components/commit/d1896dc))
* chore(release): 5.0.271 🎉 ([d9acf38](https://github.com/paypal/paypal-checkout-components/commit/d9acf38))
* chore(release): 5.0.272 🎉 ([3ef554e](https://github.com/paypal/paypal-checkout-components/commit/3ef554e))
* chore(release): 5.0.273 🎉 ([ab8fa82](https://github.com/paypal/paypal-checkout-components/commit/ab8fa82))
* chore(release): 5.0.274 🎉 ([9bdb87b](https://github.com/paypal/paypal-checkout-components/commit/9bdb87b))
* chore(release): 5.0.275 🎉 ([a1ec82c](https://github.com/paypal/paypal-checkout-components/commit/a1ec82c))
* chore(release): 5.0.276 🎉 ([787a539](https://github.com/paypal/paypal-checkout-components/commit/787a539))
* chore(release): 5.0.277 🎉 ([9902f8e](https://github.com/paypal/paypal-checkout-components/commit/9902f8e))
* chore(release): 5.0.278 🎉 ([8275580](https://github.com/paypal/paypal-checkout-components/commit/8275580))
* chore(release): 5.0.279 🎉 ([0d3bbf5](https://github.com/paypal/paypal-checkout-components/commit/0d3bbf5))
* chore(release): 5.0.28 :tada: ([4972c7d](https://github.com/paypal/paypal-checkout-components/commit/4972c7d))
* chore(release): 5.0.280 🎉 ([9227d40](https://github.com/paypal/paypal-checkout-components/commit/9227d40))
* chore(release): 5.0.281 🎉 ([7777bd3](https://github.com/paypal/paypal-checkout-components/commit/7777bd3))
* chore(release): 5.0.282 🎉 ([3a76edc](https://github.com/paypal/paypal-checkout-components/commit/3a76edc))
* chore(release): 5.0.283 🎉 ([fa83159](https://github.com/paypal/paypal-checkout-components/commit/fa83159))
* chore(release): 5.0.284 🎉 ([c38b3ef](https://github.com/paypal/paypal-checkout-components/commit/c38b3ef))
* chore(release): 5.0.285 🎉 ([f754079](https://github.com/paypal/paypal-checkout-components/commit/f754079))
* chore(release): 5.0.286 🎉 ([3a6bf6f](https://github.com/paypal/paypal-checkout-components/commit/3a6bf6f))
* chore(release): 5.0.287 🎉 ([a5224c6](https://github.com/paypal/paypal-checkout-components/commit/a5224c6))
* chore(release): 5.0.288 🎉 ([0b070d8](https://github.com/paypal/paypal-checkout-components/commit/0b070d8))
* chore(release): 5.0.289 🎉 ([8db2962](https://github.com/paypal/paypal-checkout-components/commit/8db2962))
* chore(release): 5.0.29 :tada: ([5229fa8](https://github.com/paypal/paypal-checkout-components/commit/5229fa8))
* chore(release): 5.0.290 🎉 ([1cea6a3](https://github.com/paypal/paypal-checkout-components/commit/1cea6a3))
* chore(release): 5.0.291 🎉 ([635ab8b](https://github.com/paypal/paypal-checkout-components/commit/635ab8b))
* chore(release): 5.0.292 🎉 ([133df59](https://github.com/paypal/paypal-checkout-components/commit/133df59))
* chore(release): 5.0.293 🎉 ([22d7f31](https://github.com/paypal/paypal-checkout-components/commit/22d7f31))
* chore(release): 5.0.294 🎉 ([8e6c976](https://github.com/paypal/paypal-checkout-components/commit/8e6c976))
* chore(release): 5.0.295 🎉 ([0f9cde3](https://github.com/paypal/paypal-checkout-components/commit/0f9cde3))
* chore(release): 5.0.296 🎉 ([0dd3e7f](https://github.com/paypal/paypal-checkout-components/commit/0dd3e7f))
* chore(release): 5.0.297 🎉 ([4c53eff](https://github.com/paypal/paypal-checkout-components/commit/4c53eff))
* chore(release): 5.0.298 🎉 ([0715d30](https://github.com/paypal/paypal-checkout-components/commit/0715d30))
* chore(release): 5.0.299 🎉 ([f841797](https://github.com/paypal/paypal-checkout-components/commit/f841797))
* chore(release): 5.0.3 :tada: ([5740cab](https://github.com/paypal/paypal-checkout-components/commit/5740cab))
* chore(release): 5.0.30 :tada: ([ef3c4b9](https://github.com/paypal/paypal-checkout-components/commit/ef3c4b9))
* chore(release): 5.0.300 🎉 ([39b66ec](https://github.com/paypal/paypal-checkout-components/commit/39b66ec))
* chore(release): 5.0.301 🎉 ([e67ac87](https://github.com/paypal/paypal-checkout-components/commit/e67ac87))
* chore(release): 5.0.302 🎉 ([c2eaf53](https://github.com/paypal/paypal-checkout-components/commit/c2eaf53))
* chore(release): 5.0.303 🎉 ([ef84ca5](https://github.com/paypal/paypal-checkout-components/commit/ef84ca5))
* chore(release): 5.0.304 🎉 ([c3337fb](https://github.com/paypal/paypal-checkout-components/commit/c3337fb))
* chore(release): 5.0.305 🎉 ([e49afbc](https://github.com/paypal/paypal-checkout-components/commit/e49afbc))
* chore(release): 5.0.306 🎉 ([e8b7b27](https://github.com/paypal/paypal-checkout-components/commit/e8b7b27))
* chore(release): 5.0.307 🎉 ([c4c49c1](https://github.com/paypal/paypal-checkout-components/commit/c4c49c1))
* chore(release): 5.0.308 🎉 ([88013ea](https://github.com/paypal/paypal-checkout-components/commit/88013ea))
* chore(release): 5.0.309 🎉 ([df8ff94](https://github.com/paypal/paypal-checkout-components/commit/df8ff94))
* chore(release): 5.0.31 :tada: ([7f23646](https://github.com/paypal/paypal-checkout-components/commit/7f23646))
* chore(release): 5.0.310 🎉 ([3a8db04](https://github.com/paypal/paypal-checkout-components/commit/3a8db04))
* chore(release): 5.0.311 🎉 ([71026ef](https://github.com/paypal/paypal-checkout-components/commit/71026ef))
* chore(release): 5.0.312 🎉 ([b1d9819](https://github.com/paypal/paypal-checkout-components/commit/b1d9819))
* chore(release): 5.0.313 🎉 ([acb7974](https://github.com/paypal/paypal-checkout-components/commit/acb7974))
* chore(release): 5.0.314 🎉 ([c4bed5a](https://github.com/paypal/paypal-checkout-components/commit/c4bed5a))
* chore(release): 5.0.315 🎉 ([5e4fb87](https://github.com/paypal/paypal-checkout-components/commit/5e4fb87))
* chore(release): 5.0.316 🎉 ([255c9f5](https://github.com/paypal/paypal-checkout-components/commit/255c9f5))
* chore(release): 5.0.317 🎉 ([01fca3b](https://github.com/paypal/paypal-checkout-components/commit/01fca3b))
* chore(release): 5.0.318 🎉 ([83e5751](https://github.com/paypal/paypal-checkout-components/commit/83e5751))
* chore(release): 5.0.319 🎉 ([bb12045](https://github.com/paypal/paypal-checkout-components/commit/bb12045))
* chore(release): 5.0.32 :tada: ([38e0c19](https://github.com/paypal/paypal-checkout-components/commit/38e0c19))
* chore(release): 5.0.320 🎉 ([7def829](https://github.com/paypal/paypal-checkout-components/commit/7def829))
* chore(release): 5.0.321 🎉 ([ee5e6d3](https://github.com/paypal/paypal-checkout-components/commit/ee5e6d3))
* chore(release): 5.0.322 🎉 ([57e2853](https://github.com/paypal/paypal-checkout-components/commit/57e2853))
* chore(release): 5.0.323 🎉 ([8ca8479](https://github.com/paypal/paypal-checkout-components/commit/8ca8479))
* chore(release): 5.0.324 🎉 ([4140f50](https://github.com/paypal/paypal-checkout-components/commit/4140f50))
* chore(release): 5.0.325 🎉 ([1ef1b06](https://github.com/paypal/paypal-checkout-components/commit/1ef1b06))
* chore(release): 5.0.326 🎉 ([99a8580](https://github.com/paypal/paypal-checkout-components/commit/99a8580))
* chore(release): 5.0.327 🎉 ([973267f](https://github.com/paypal/paypal-checkout-components/commit/973267f))
* chore(release): 5.0.328 🎉 ([11eb6ae](https://github.com/paypal/paypal-checkout-components/commit/11eb6ae))
* chore(release): 5.0.329 🎉 ([3ae4627](https://github.com/paypal/paypal-checkout-components/commit/3ae4627))
* chore(release): 5.0.33 :tada: ([0075586](https://github.com/paypal/paypal-checkout-components/commit/0075586))
* chore(release): 5.0.330 🎉 ([3d7041d](https://github.com/paypal/paypal-checkout-components/commit/3d7041d))
* chore(release): 5.0.331 🎉 ([359f5c7](https://github.com/paypal/paypal-checkout-components/commit/359f5c7))
* chore(release): 5.0.332 🎉 ([dd43ad6](https://github.com/paypal/paypal-checkout-components/commit/dd43ad6))
* chore(release): 5.0.333 🎉 ([2fe7933](https://github.com/paypal/paypal-checkout-components/commit/2fe7933))
* chore(release): 5.0.334 🎉 ([158e094](https://github.com/paypal/paypal-checkout-components/commit/158e094))
* chore(release): 5.0.335 🎉 ([46f5c51](https://github.com/paypal/paypal-checkout-components/commit/46f5c51))
* chore(release): 5.0.336 🎉 ([67ace6d](https://github.com/paypal/paypal-checkout-components/commit/67ace6d))
* chore(release): 5.0.337 🎉 ([ac190e3](https://github.com/paypal/paypal-checkout-components/commit/ac190e3))
* chore(release): 5.0.338 🎉 ([0c688c9](https://github.com/paypal/paypal-checkout-components/commit/0c688c9))
* chore(release): 5.0.339 🎉 ([7d57c93](https://github.com/paypal/paypal-checkout-components/commit/7d57c93))
* chore(release): 5.0.34 :tada: ([c997e22](https://github.com/paypal/paypal-checkout-components/commit/c997e22))
* chore(release): 5.0.340 🎉 ([a159b60](https://github.com/paypal/paypal-checkout-components/commit/a159b60))
* chore(release): 5.0.341 🎉 ([2d91afd](https://github.com/paypal/paypal-checkout-components/commit/2d91afd))
* chore(release): 5.0.342 🎉 ([32001ff](https://github.com/paypal/paypal-checkout-components/commit/32001ff))
* chore(release): 5.0.343 🎉 ([798390b](https://github.com/paypal/paypal-checkout-components/commit/798390b))
* chore(release): 5.0.344 🎉 ([be30a3b](https://github.com/paypal/paypal-checkout-components/commit/be30a3b))
* chore(release): 5.0.345 🎉 ([7d12516](https://github.com/paypal/paypal-checkout-components/commit/7d12516))
* chore(release): 5.0.346 🎉 ([b7545fa](https://github.com/paypal/paypal-checkout-components/commit/b7545fa))
* chore(release): 5.0.347 🎉 ([a1618be](https://github.com/paypal/paypal-checkout-components/commit/a1618be))
* chore(release): 5.0.348 🎉 ([0b923aa](https://github.com/paypal/paypal-checkout-components/commit/0b923aa))
* chore(release): 5.0.349 🎉 ([3fc257a](https://github.com/paypal/paypal-checkout-components/commit/3fc257a))
* chore(release): 5.0.35 :tada: ([ca91c2e](https://github.com/paypal/paypal-checkout-components/commit/ca91c2e))
* chore(release): 5.0.350 🎉 ([e691f89](https://github.com/paypal/paypal-checkout-components/commit/e691f89))
* chore(release): 5.0.351 🎉 ([4f8eb87](https://github.com/paypal/paypal-checkout-components/commit/4f8eb87))
* chore(release): 5.0.352 🎉 ([fc48a5d](https://github.com/paypal/paypal-checkout-components/commit/fc48a5d))
* chore(release): 5.0.353 🎉 ([f00fcf4](https://github.com/paypal/paypal-checkout-components/commit/f00fcf4))
* chore(release): 5.0.354 🎉 ([cb4c897](https://github.com/paypal/paypal-checkout-components/commit/cb4c897))
* chore(release): 5.0.355 🎉 ([4f38b43](https://github.com/paypal/paypal-checkout-components/commit/4f38b43))
* chore(release): 5.0.356 🎉 ([da139fa](https://github.com/paypal/paypal-checkout-components/commit/da139fa))
* chore(release): 5.0.357 🎉 ([d3dab87](https://github.com/paypal/paypal-checkout-components/commit/d3dab87))
* chore(release): 5.0.358 🎉 ([589d26e](https://github.com/paypal/paypal-checkout-components/commit/589d26e))
* chore(release): 5.0.359 🎉 ([b23d54e](https://github.com/paypal/paypal-checkout-components/commit/b23d54e))
* chore(release): 5.0.36 :tada: ([2a2aa76](https://github.com/paypal/paypal-checkout-components/commit/2a2aa76))
* chore(release): 5.0.360 🎉 ([4acd652](https://github.com/paypal/paypal-checkout-components/commit/4acd652))
* chore(release): 5.0.361 🎉 ([f9ae6ee](https://github.com/paypal/paypal-checkout-components/commit/f9ae6ee))
* chore(release): 5.0.362 🎉 ([98ac7ea](https://github.com/paypal/paypal-checkout-components/commit/98ac7ea))
* chore(release): 5.0.363 🎉 ([3870804](https://github.com/paypal/paypal-checkout-components/commit/3870804))
* chore(release): 5.0.364 🎉 ([b8d8b80](https://github.com/paypal/paypal-checkout-components/commit/b8d8b80))
* chore(release): 5.0.365 🎉 ([eb11d7e](https://github.com/paypal/paypal-checkout-components/commit/eb11d7e))
* chore(release): 5.0.366 🎉 ([4ba96d0](https://github.com/paypal/paypal-checkout-components/commit/4ba96d0))
* chore(release): 5.0.367 🎉 ([0d70ecf](https://github.com/paypal/paypal-checkout-components/commit/0d70ecf))
* chore(release): 5.0.368 🎉 ([29a6f68](https://github.com/paypal/paypal-checkout-components/commit/29a6f68))
* chore(release): 5.0.369 🎉 ([44e28e2](https://github.com/paypal/paypal-checkout-components/commit/44e28e2))
* chore(release): 5.0.37 :tada: ([050fc0f](https://github.com/paypal/paypal-checkout-components/commit/050fc0f))
* chore(release): 5.0.370 🎉 ([4daef37](https://github.com/paypal/paypal-checkout-components/commit/4daef37))
* chore(release): 5.0.371 🎉 ([a0c47fa](https://github.com/paypal/paypal-checkout-components/commit/a0c47fa))
* chore(release): 5.0.372 🎉 ([8405013](https://github.com/paypal/paypal-checkout-components/commit/8405013))
...
* chore(release): 5.0.377 🎉 (#2530) ([b9f9966](https://github.com/paypal/paypal-checkout-components/commit/b9f9966)), closes [#2530](https://github.com/paypal/paypal-checkout-components/issues/2530)
* chore(release): 5.0.378 🎉  ([763b0e0](https://github.com/paypal/paypal-checkout-components/commit/763b0e0))
* chore(release): 5.0.379 🎉 ([3c0e208](https://github.com/paypal/paypal-checkout-components/commit/3c0e208))
* chore(release): 5.0.38 :tada: ([511cc44](https://github.com/paypal/paypal-checkout-components/commit/511cc44))
* chore(release): 5.0.380 🎉 ([35bf161](https://github.com/paypal/paypal-checkout-components/commit/35bf161))
* chore(release): 5.0.381 🎉 ([3e7fde2](https://github.com/paypal/paypal-checkout-components/commit/3e7fde2))
* chore(release): 5.0.382 🎉 ([4a0ed37](https://github.com/paypal/paypal-checkout-components/commit/4a0ed37))
* chore(release): 5.0.383 🎉 ([fa406f4](https://github.com/paypal/paypal-checkout-components/commit/fa406f4))
* chore(release): 5.0.384 🎉 ([9a9f005](https://github.com/paypal/paypal-checkout-components/commit/9a9f005))
* chore(release): 5.0.385 🎉 ([230ceb6](https://github.com/paypal/paypal-checkout-components/commit/230ceb6))
* chore(release): 5.0.386 🎉 ([aa613c1](https://github.com/paypal/paypal-checkout-components/commit/aa613c1))
* chore(release): 5.0.387 🎉 ([09f32b3](https://github.com/paypal/paypal-checkout-components/commit/09f32b3))
* chore(release): 5.0.388 🎉 ([567e50e](https://github.com/paypal/paypal-checkout-components/commit/567e50e))
* chore(release): 5.0.389 🎉 ([564931c](https://github.com/paypal/paypal-checkout-components/commit/564931c))
* chore(release): 5.0.39 :tada: ([f14ae4e](https://github.com/paypal/paypal-checkout-components/commit/f14ae4e))
* chore(release): 5.0.390 🎉 ([1653497](https://github.com/paypal/paypal-checkout-components/commit/1653497))
* chore(release): 5.0.391 🎉 ([a051b3a](https://github.com/paypal/paypal-checkout-components/commit/a051b3a))
* chore(release): 5.0.392 🎉 ([9f29832](https://github.com/paypal/paypal-checkout-components/commit/9f29832))
* chore(release): 5.0.393 🎉 ([9a21533](https://github.com/paypal/paypal-checkout-components/commit/9a21533))
* chore(release): 5.0.394 🎉 ([c24510b](https://github.com/paypal/paypal-checkout-components/commit/c24510b))
* chore(release): 5.0.395 🎉 ([7c0d726](https://github.com/paypal/paypal-checkout-components/commit/7c0d726))
* chore(release): 5.0.396 🎉 ([9d56c2b](https://github.com/paypal/paypal-checkout-components/commit/9d56c2b))
* chore(release): 5.0.397 🎉 ([7ef1eae](https://github.com/paypal/paypal-checkout-components/commit/7ef1eae))
* chore(release): 5.0.398 🎉 ([1c837ef](https://github.com/paypal/paypal-checkout-components/commit/1c837ef))
* chore(release): 5.0.399 🎉 ([8ad7d3b](https://github.com/paypal/paypal-checkout-components/commit/8ad7d3b))
* chore(release): 5.0.4 :tada: ([48f03c6](https://github.com/paypal/paypal-checkout-components/commit/48f03c6))
* chore(release): 5.0.40 :tada: ([e15200d](https://github.com/paypal/paypal-checkout-components/commit/e15200d))
* chore(release): 5.0.41 :tada: ([ff9172d](https://github.com/paypal/paypal-checkout-components/commit/ff9172d))
* chore(release): 5.0.42 :tada: ([f6e4210](https://github.com/paypal/paypal-checkout-components/commit/f6e4210))
* chore(release): 5.0.43 :tada: ([b2996bf](https://github.com/paypal/paypal-checkout-components/commit/b2996bf))
* chore(release): 5.0.44 :tada: ([764b2d0](https://github.com/paypal/paypal-checkout-components/commit/764b2d0))
* chore(release): 5.0.45 :tada: ([5600ab8](https://github.com/paypal/paypal-checkout-components/commit/5600ab8))
* chore(release): 5.0.46 :tada: ([458a914](https://github.com/paypal/paypal-checkout-components/commit/458a914))
* chore(release): 5.0.47 :tada: ([c8cb31c](https://github.com/paypal/paypal-checkout-components/commit/c8cb31c))
* chore(release): 5.0.48 :tada: ([78151ca](https://github.com/paypal/paypal-checkout-components/commit/78151ca))
* chore(release): 5.0.49 :tada: ([ee4cc15](https://github.com/paypal/paypal-checkout-components/commit/ee4cc15))
* chore(release): 5.0.5 :tada: ([5f1cd89](https://github.com/paypal/paypal-checkout-components/commit/5f1cd89))
* chore(release): 5.0.50 :tada: ([6429476](https://github.com/paypal/paypal-checkout-components/commit/6429476))
* chore(release): 5.0.51 :tada: ([5ce866e](https://github.com/paypal/paypal-checkout-components/commit/5ce866e))
* chore(release): 5.0.52 :tada: ([896dd2f](https://github.com/paypal/paypal-checkout-components/commit/896dd2f))
* chore(release): 5.0.53 :tada: ([5dde7ef](https://github.com/paypal/paypal-checkout-components/commit/5dde7ef))
* chore(release): 5.0.54 :tada: ([7a55f4f](https://github.com/paypal/paypal-checkout-components/commit/7a55f4f))
* chore(release): 5.0.55 :tada: ([c79740b](https://github.com/paypal/paypal-checkout-components/commit/c79740b))
* chore(release): 5.0.56 :tada: ([dc09a2b](https://github.com/paypal/paypal-checkout-components/commit/dc09a2b))
* chore(release): 5.0.57 :tada: ([abe335b](https://github.com/paypal/paypal-checkout-components/commit/abe335b))
* chore(release): 5.0.58 :tada: ([29ee7dd](https://github.com/paypal/paypal-checkout-components/commit/29ee7dd))
* chore(release): 5.0.59 :tada: ([8110cd2](https://github.com/paypal/paypal-checkout-components/commit/8110cd2))
* chore(release): 5.0.6 :tada: ([a8f49e9](https://github.com/paypal/paypal-checkout-components/commit/a8f49e9))
* chore(release): 5.0.60 :tada: ([2a79283](https://github.com/paypal/paypal-checkout-components/commit/2a79283))
* chore(release): 5.0.61 :tada: ([478a085](https://github.com/paypal/paypal-checkout-components/commit/478a085))
* chore(release): 5.0.62 :tada: ([c186ce4](https://github.com/paypal/paypal-checkout-components/commit/c186ce4))
* chore(release): 5.0.63 :tada: ([690e518](https://github.com/paypal/paypal-checkout-components/commit/690e518))
* chore(release): 5.0.64 :tada: ([fecd3f2](https://github.com/paypal/paypal-checkout-components/commit/fecd3f2))
* chore(release): 5.0.65 :tada: ([669d011](https://github.com/paypal/paypal-checkout-components/commit/669d011))
* chore(release): 5.0.66 :tada: ([adf2b42](https://github.com/paypal/paypal-checkout-components/commit/adf2b42))
* chore(release): 5.0.67 :tada: ([99711af](https://github.com/paypal/paypal-checkout-components/commit/99711af))
* chore(release): 5.0.68 :tada: ([e30c29a](https://github.com/paypal/paypal-checkout-components/commit/e30c29a))
* chore(release): 5.0.69 :tada: ([e1ef0e7](https://github.com/paypal/paypal-checkout-components/commit/e1ef0e7))
* chore(release): 5.0.7 :tada: ([5992c8b](https://github.com/paypal/paypal-checkout-components/commit/5992c8b))
* chore(release): 5.0.70 :tada: ([ff32835](https://github.com/paypal/paypal-checkout-components/commit/ff32835))
* chore(release): 5.0.71 :tada: ([6cfc705](https://github.com/paypal/paypal-checkout-components/commit/6cfc705))
* chore(release): 5.0.72 :tada: ([30a8f93](https://github.com/paypal/paypal-checkout-components/commit/30a8f93))
* chore(release): 5.0.73 :tada: ([a3db947](https://github.com/paypal/paypal-checkout-components/commit/a3db947))
* chore(release): 5.0.74 :tada: ([6febcba](https://github.com/paypal/paypal-checkout-components/commit/6febcba))
* chore(release): 5.0.75 :tada: ([cb7034e](https://github.com/paypal/paypal-checkout-components/commit/cb7034e))
* chore(release): 5.0.76 :tada: ([411b246](https://github.com/paypal/paypal-checkout-components/commit/411b246))
* chore(release): 5.0.77 :tada: ([53c1214](https://github.com/paypal/paypal-checkout-components/commit/53c1214))
* chore(release): 5.0.78 :tada: ([3cf3cfe](https://github.com/paypal/paypal-checkout-components/commit/3cf3cfe))
* chore(release): 5.0.79 :tada: ([9f9f4d8](https://github.com/paypal/paypal-checkout-components/commit/9f9f4d8))
* chore(release): 5.0.8 :tada: ([9062d47](https://github.com/paypal/paypal-checkout-components/commit/9062d47))
* chore(release): 5.0.80 :tada: ([10ea387](https://github.com/paypal/paypal-checkout-components/commit/10ea387))
* chore(release): 5.0.81 :tada: ([d5b36e6](https://github.com/paypal/paypal-checkout-components/commit/d5b36e6))
* chore(release): 5.0.82 :tada: ([148ed15](https://github.com/paypal/paypal-checkout-components/commit/148ed15))
* chore(release): 5.0.83 :tada: ([be5c7d1](https://github.com/paypal/paypal-checkout-components/commit/be5c7d1))
* chore(release): 5.0.84 :tada: ([efdc11b](https://github.com/paypal/paypal-checkout-components/commit/efdc11b))
* chore(release): 5.0.85 :tada: ([a85d6c9](https://github.com/paypal/paypal-checkout-components/commit/a85d6c9))
* chore(release): 5.0.86 :tada: ([f0641a3](https://github.com/paypal/paypal-checkout-components/commit/f0641a3))
* chore(release): 5.0.87 :tada: ([93e1b63](https://github.com/paypal/paypal-checkout-components/commit/93e1b63))
* chore(release): 5.0.88 :tada: ([61a9d86](https://github.com/paypal/paypal-checkout-components/commit/61a9d86))
* chore(release): 5.0.89 :tada: ([d154ed1](https://github.com/paypal/paypal-checkout-components/commit/d154ed1))
* chore(release): 5.0.9 :tada: ([575e6cc](https://github.com/paypal/paypal-checkout-components/commit/575e6cc))
* chore(release): 5.0.90 :tada: ([8754e78](https://github.com/paypal/paypal-checkout-components/commit/8754e78))
* chore(release): 5.0.91 :tada: ([5ecd8c5](https://github.com/paypal/paypal-checkout-components/commit/5ecd8c5))
* chore(release): 5.0.92 :tada: ([b783859](https://github.com/paypal/paypal-checkout-components/commit/b783859))
* chore(release): 5.0.93 :tada: ([357f710](https://github.com/paypal/paypal-checkout-components/commit/357f710))
* chore(release): 5.0.94 :tada: ([cf96d31](https://github.com/paypal/paypal-checkout-components/commit/cf96d31))
* chore(release): 5.0.95 :tada: ([c6ea687](https://github.com/paypal/paypal-checkout-components/commit/c6ea687))
* chore(release): 5.0.96 :tada: ([1b66936](https://github.com/paypal/paypal-checkout-components/commit/1b66936))
* chore(release): 5.0.97 :tada: ([ad85573](https://github.com/paypal/paypal-checkout-components/commit/ad85573))
* chore(release): 5.0.98 :tada: ([de30ffa](https://github.com/paypal/paypal-checkout-components/commit/de30ffa))
* chore(release): 5.0.99 :tada: ([723f3f5](https://github.com/paypal/paypal-checkout-components/commit/723f3f5))
* fix: add clientMetadataID prop to standard card fields (#1979) ([4768378](https://github.com/paypal/paypal-checkout-components/commit/4768378)), closes [#1979](https://github.com/paypal/paypal-checkout-components/issues/1979)
* fix: add cookie global to test configs (#2187) ([2ccfba9](https://github.com/paypal/paypal-checkout-components/commit/2ccfba9)), closes [#2187](https://github.com/paypal/paypal-checkout-components/issues/2187)
* fix: add country.x for node-locale localization (#2070) ([8c288b6](https://github.com/paypal/paypal-checkout-components/commit/8c288b6)), closes [#2070](https://github.com/paypal/paypal-checkout-components/issues/2070)
...
* fix: add missing html tags (#2123) ([a351f54](https://github.com/paypal/paypal-checkout-components/commit/a351f54)), closes [#2123](https://github.com/paypal/paypal-checkout-components/issues/2123)
...
* fix: update npm access token name (#2585) ([e43a821](https://github.com/paypal/paypal-checkout-components/commit/e43a821)), closes [#2585](https://github.com/paypal/paypal-checkout-components/issues/2585)
...
* fix: use unicode emoji for version message (#1814) ([84dea4f](https://github.com/paypal/paypal-checkout-components/commit/84dea4f)), closes [#1814](https://github.com/paypal/paypal-checkout-components/issues/1814)
...
* fix(BNPL): fix aria-label for Pay Later button (#1882) ([3b7a368](https://github.com/paypal/paypal-checkout-components/commit/3b7a368)), closes [#1882](https://github.com/paypal/paypal-checkout-components/issues/1882)
...
* fix(hosted-buttons): fix an issue where shipping callbacks would not throw (#2427) ([8054bc1](https://github.com/paypal/paypal-checkout-components/commit/8054bc1)), closes [#2427](https://github.com/paypal/paypal-checkout-components/issues/2427)
...
* fix(venmo): required popup:true #2406 ([23c2b1d](https://github.com/paypal/paypal-checkout-components/commit/23c2b1d)), closes [#2406](https://github.com/paypal/paypal-checkout-components/issues/2406)
* fix(venmo): web config (#2189) ([d7fca3e](https://github.com/paypal/paypal-checkout-components/commit/d7fca3e)), closes [#2189](https://github.com/paypal/paypal-checkout-components/issues/2189)
* feat: accept data-popups-disabled attribute as valid prop  (#1838) ([65972b2](https://github.com/paypal/paypal-checkout-components/commit/65972b2)), closes [#1838](https://github.com/paypal/paypal-checkout-components/issues/1838)
* feat: add 250px rect & pill PPoF screenshots (#2073) ([a7b07be](https://github.com/paypal/paypal-checkout-components/commit/a7b07be)), closes [#2073](https://github.com/paypal/paypal-checkout-components/issues/2073)
...
* feat: add new query string prop for buttons to restrict cookies (#2188) ([6d73031](https://github.com/paypal/paypal-checkout-components/commit/6d73031)), closes [#2188](https://github.com/paypal/paypal-checkout-components/issues/2188)
...
* feat: allows button message amount type to be string (#2421) ([f1d9331](https://github.com/paypal/paypal-checkout-components/commit/f1d9331)), closes [#2421](https://github.com/paypal/paypal-checkout-components/issues/2421)
* feat: app switch resume flow (#2458) ([01a491d](https://github.com/paypal/paypal-checkout-components/commit/01a491d)), closes [#2458](https://github.com/paypal/paypal-checkout-components/issues/2458)
* feat: dynamic messages - modal instrumentation (#2380) ([f06bed1](https://github.com/paypal/paypal-checkout-components/commit/f06bed1)), closes [#2380](https://github.com/paypal/paypal-checkout-components/issues/2380)
...
* feat: screenshot testing with percy (#2067) ([8cd58bd](https://github.com/paypal/paypal-checkout-components/commit/8cd58bd)), closes [#2067](https://github.com/paypal/paypal-checkout-components/issues/2067)
...
* feat: update node version to 18 (#2464) ([08435cd](https://github.com/paypal/paypal-checkout-components/commit/08435cd)), closes [#2464](https://github.com/paypal/paypal-checkout-components/issues/2464)
* feat: updates message position logic to allow a bottom selection with 'Powered By' (#2399) ([db7798e](https://github.com/paypal/paypal-checkout-components/commit/db7798e)), closes [#2399](https://github.com/paypal/paypal-checkout-components/issues/2399)
* feat: upgrade to grumbler scripts 8 (#2030) ([f4f24cb](https://github.com/paypal/paypal-checkout-components/commit/f4f24cb)), closes [#2030](https://github.com/paypal/paypal-checkout-components/issues/2030)
...
* feat(incognito): Log FTPI event if browser can't access localstorage (#1880) ([a4d6ca6](https://github.com/paypal/paypal-checkout-components/commit/a4d6ca6)), closes [#1880](https://github.com/paypal/paypal-checkout-components/issues/1880)
...
* feat(venmo): enable webviews (#2491) ([b481ab4](https://github.com/paypal/paypal-checkout-components/commit/b481ab4)), closes [#2491](https://github.com/paypal/paypal-checkout-components/issues/2491)
...
* feat(venmo): relax eligibility (#2393) ([face822](https://github.com/paypal/paypal-checkout-components/commit/face822)), closes [#2393](https://github.com/paypal/paypal-checkout-components/issues/2393)
...
* feat(venmo): Surpress showing venmo on tablets (#1746) ([32e2575](https://github.com/paypal/paypal-checkout-components/commit/32e2575)), closes [#1746](https://github.com/paypal/paypal-checkout-components/issues/1746)
...
* feature(3DS): Implement show method and return response with enriched nonce (#2452) ([b1d2a84](https://github.com/paypal/paypal-checkout-components/commit/b1d2a84)), closes [#2452](https://github.com/paypal/paypal-checkout-components/issues/2452) [#2459](https://github.com/paypal/paypal-checkout-components/issues/2459)
...
* Feat: Add Amount to Card Fields for Improved BIN API Requests (#2457) ([71e09fa](https://github.com/paypal/paypal-checkout-components/commit/71e09fa)), closes [#2457](https://github.com/paypal/paypal-checkout-components/issues/2457)
...
* refactor: update message object to accept array offer param and  send offer as string (#2392) ([0a20fbb](https://github.com/paypal/paypal-checkout-components/commit/0a20fbb)), closes [#2392](https://github.com/paypal/paypal-checkout-components/issues/2392)
